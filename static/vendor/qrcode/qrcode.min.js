 ...
 *  Vendored as a static file (no npm build step), like the other libraries in
 *  static/vendor/. Used by static/js/auth.js to draw the 2FA enrolment QR code
 *  client-side, so the backend never needs an image-rendering dependency. */
