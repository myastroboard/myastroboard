...
def test_combination_new_fields_roundtrip(temp_data_dir, test_user_id):
    ...
    guide_cam = equipment_profiles.create_camera(
        test_user_id,
        {
            'name': 'Guide Cam',
            'manufacturer': 'ZWO',
            ...
            'resolution_width_px': 1280,
            'resolution_height_px': 960,
            'pixel_size_um': 3.75,
            'sensor_type': 'CMOS Mono',
        },
    )
    ...
    updated = equipment_profiles.update_combination(
        test_user_id,
        combo['id'],
        {
            'name': 'Wide-Field Rig',
...
def test_is_disabled_create_and_update_roundtrip_all_types(temp_data_dir, test_user_id):
    ...
    mount = equipment_profiles.update_mount(
        test_user_id,
        mount['id'],
        {
            'name': 'Mount',
    ...
    filt = equipment_profiles.update_filter(
        test_user_id,
        filt['id'],
        {
            'name': 'Filter',
    ...
    accessory = equipment_profiles.update_accessory(
        test_user_id,
        accessory['id'],
        {
            'name': 'Focuser',
    ...
    telescope = equipment_profiles.update_telescope(
        test_user_id,
        telescope['id'],
        {
            'name': 'T',
...
class TestEquipmentDeleteGuard:
    ...
    def test_delete_combination_blocked_by_session(self, temp_data_dir, test_user_id, monkeypatch):
        ...
        monkeypatch.setattr(observation_sessions_module, 'count_sessions_for_combination', lambda combination_id: 1)
        success, reason = equipment_profiles.delete_combination(test_user_id, combo['id'])
        assert success is False
        assert reason == 'in_use_by_session'

        monkeypatch.setattr(observation_sessions_module, 'count_sessions_for_combination', lambda combination_id: 0)
        success, reason = equipment_profiles.delete_combination(test_user_id, combo['id'])
        assert success is True
        assert reason is None
    ...
    def test_delete_camera_blocked_as_guide_camera(self, temp_data_dir, test_user_id):
        ...
        main_camera = equipment_profiles.create_camera(
            test_user_id,
            {
                'name': 'Main',
                'manufacturer': 'M',
        ...
        guide_camera = equipment_profiles.create_camera(
            test_user_id,
            {
                'name': 'Guide',
                'manufacturer': 'M',
        ...
        equipment_profiles.create_combination(
            ...
            {
                'name': 'Combo',
                'camera_id': main_camera['id'],
                'guide_camera_id': guide_camera['id'],
            },
        )
...
class TestFindCombinationsReferencing:
    ...
    def test_matches_via_list_field(self, temp_data_dir, test_user_id):
        accessory = equipment_profiles.create_accessory(
            ...
            {
                'name': 'OAG',
                'accessory_type': 'Off-Axis Guider',
            },
        )
        telescope = equipment_profiles.create_telescope(
            test_user_id,
    ...
    def test_no_matches_returns_empty_list(self, temp_data_dir, test_user_id):
        equipment_profiles.create_telescope(
            test_user_id,
            {
                'name': 'T',
                'telescope_type': 'Refractor',
...
class TestComputeValidityStatusBranches:
    ...
    def test_disabled_component_makes_combination_invalid(self, temp_data_dir, test_user_id):
        ...
        equipment_profiles.update_telescope(
            test_user_id,
            telescope['id'],
            {
                'name': 'T',
    ...
    def test_missing_component_makes_combination_invalid(self, temp_data_dir, test_user_id):
        ...
        combo = {
            'telescope_id': 'ghost-id',
            'camera_id': None,
            'mount_id': None,
            'guide_camera_id': None,
            'filter_ids': [],
            'accessory_ids': [],
        }
        status = equipment_profiles.compute_combination_validity_status(combo, test_user_id)
...
def test_analyze_combination(temp_data_dir, test_user_id):
    ...
    combination = equipment_profiles.create_combination(
        test_user_id, {'name': 'Wide-Field Setup', 'telescope_id': telescope['id'], 'camera_id': camera['id']}
    )
...
def test_equipment_summary(temp_data_dir, test_user_id):
    ...
    equipment_profiles.create_camera(
        test_user_id,
        {
            'name': 'Camera 1',
            'manufacturer': 'Test',
...
class TestDataclassBranchCoverage:
    ...
    def test_normalize_mount_flip_fields_alt_az_and_idempotent(self):
        ...
        already = {
            ...
            'name': 'EQ',
            'mount_type': 'Equatorial',
            'meridian_flip_required': False,
            'meridian_flip_delay_min': 7.0,
            'meridian_flip_duration_min': 3.0,
        }
...
class TestCRUDExceptionAndNotFound:
    ...
    def test_create_telescope_exception_returns_none(self, temp_data_dir, test_user_id):
        result = equipment_profiles.create_telescope(
            test_user_id,
            {
                'name': 'Bad Scope',
                'telescope_type': 'Refractor',
    ...
    def test_update_telescope_id_not_found_with_items(self, temp_data_dir, test_user_id):
        ...
        result = equipment_profiles.update_telescope(
            test_user_id,
            'nonexistent-id',
            {
                'name': 'Updated',
    ...
    def test_create_camera_exception_returns_none(self, temp_data_dir, test_user_id):
        result = equipment_profiles.create_camera(
            test_user_id,
            {
                'name': 'Bad Cam',
                'manufacturer': 'Test',
    ...
    def test_update_camera_id_not_found_with_items(self, temp_data_dir, test_user_id):
        ...
        result = equipment_profiles.update_camera(
            test_user_id,
            'nonexistent-id',
            {
                'name': 'Updated',
    ...
    def test_create_mount_exception_returns_none(self, temp_data_dir, test_user_id):
        result = equipment_profiles.create_mount(
            test_user_id,
            {
                'name': 'Bad Mount',
                'mount_type': 'Equatorial',
    ...
    def test_get_mount_items_exist_but_id_not_found(self, temp_data_dir, test_user_id):
        equipment_profiles.create_mount(
            test_user_id,
            {
                'name': 'Mount',
                'mount_type': 'Equatorial',
    ...
    def test_update_mount_id_not_found_with_items(self, temp_data_dir, test_user_id):
        ...
        result = equipment_profiles.update_mount(
            test_user_id,
            'nonexistent-id',
            {
                'name': 'Updated',
...
class TestEquipmentSaveFailurePaths:
    ...
    def test_create_telescope_save_fails_returns_none(self, temp_data_dir, test_user_id, monkeypatch):
        ...
        result = equipment_profiles.create_telescope(
            test_user_id, {'name': 'T', 'telescope_type': 'Refractor', 'aperture_mm': 100, 'focal_length_mm': 1000}
        )
        assert result is None
    ...
    def test_update_camera_save_fails_returns_none(self, temp_data_dir, test_user_id, monkeypatch):
        ...
        cam = equipment_profiles.create_camera(
            test_user_id,
            {
                'name': 'C',
                'manufacturer': 'M',
    ...
    def test_create_mount_save_fails_returns_none(self, temp_data_dir, test_user_id, monkeypatch):
        ...
        result = equipment_profiles.create_mount(
            test_user_id, {'name': 'M', 'mount_type': 'Equatorial', 'payload_capacity_kg': 10}
        )
        assert result is None
    ...
    def test_update_mount_save_fails_returns_none(self, temp_data_dir, test_user_id, monkeypatch):
        ...
        monkeypatch.setattr(equipment_profiles, 'save_user_mounts', lambda *_: False)
        result = equipment_profiles.update_mount(
            test_user_id, mount['id'], {'name': 'M2', 'mount_type': 'Equatorial', 'payload_capacity_kg': 12}
        )
        assert result is None
    ...
    def test_create_filter_save_fails_returns_none(self, temp_data_dir, test_user_id, monkeypatch):
        ...
        result = equipment_profiles.create_filter(test_user_id, {'name': 'H-alpha', 'filter_type': 'Narrowband'})
        assert result is None
    ...
    def test_update_filter_save_fails_returns_none(self, temp_data_dir, test_user_id, monkeypatch):
        ...
        monkeypatch.setattr(equipment_profiles, 'save_user_filters', lambda *_: False)
        result = equipment_profiles.update_filter(test_user_id, f['id'], {'name': 'F2', 'filter_type': 'Narrowband'})
        assert result is None
    ...
    def test_create_combination_save_fails_returns_none(self, temp_data_dir, test_user_id, monkeypatch):
        ...
        result = equipment_profiles.create_combination(test_user_id, {'name': 'Combo', 'telescope_id': scope['id']})
        assert result is None
    ...
    def test_update_combination_save_fails_returns_none(self, temp_data_dir, test_user_id, monkeypatch):
        ...
        combo = equipment_profiles.create_combination(test_user_id, {'name': 'Combo', 'telescope_id': scope['id']})
        monkeypatch.setattr(equipment_profiles, 'save_user_combinations', lambda *_: False)
        result = equipment_profiles.update_combination(
            test_user_id, combo['id'], {'name': 'Updated', 'telescope_id': scope['id']}
        )
        assert result is None
...
class TestEquipmentDeleteExceptions:
    ...
    def test_delete_telescope_load_exception_returns_false(self, temp_data_dir, test_user_id, monkeypatch):
        ...
        monkeypatch.setattr(
            equipment_profiles, 'load_user_telescopes', lambda *_: (_ for _ in ()).throw(RuntimeError("disk error"))
        )
    ...
    def test_delete_camera_load_exception_returns_false(self, temp_data_dir, test_user_id, monkeypatch):
        ...
        monkeypatch.setattr(
            equipment_profiles, 'load_user_cameras', lambda *_: (_ for _ in ()).throw(RuntimeError("disk error"))
        )
    ...
    def test_delete_mount_load_exception_returns_false(self, temp_data_dir, test_user_id, monkeypatch):
        ...
        monkeypatch.setattr(
            equipment_profiles, 'load_user_mounts', lambda *_: (_ for _ in ()).throw(RuntimeError("disk error"))
        )
    ...
    def test_delete_filter_load_exception_returns_false(self, temp_data_dir, test_user_id, monkeypatch):
        ...
        monkeypatch.setattr(
            equipment_profiles, 'load_user_filters', lambda *_: (_ for _ in ()).throw(RuntimeError("disk error"))
        )
    ...
    def test_delete_accessory_load_exception_returns_false(self, temp_data_dir, test_user_id, monkeypatch):
        ...
        monkeypatch.setattr(
            equipment_profiles, 'load_user_accessories', lambda *_: (_ for _ in ()).throw(RuntimeError("disk error"))
        )
    ...
    def test_delete_combination_load_exception_returns_false(self, temp_data_dir, test_user_id, monkeypatch):
        ...
        monkeypatch.setattr(
            equipment_profiles, 'load_user_combinations', lambda *_: (_ for _ in ()).throw(RuntimeError("disk error"))
        )
...
class TestEquipmentGetSuccessPaths:
    ...
    def test_get_combination_found(self, temp_data_dir, test_user_id):
        ...
        combo = equipment_profiles.create_combination(test_user_id, {'name': 'C', 'telescope_id': scope['id']})
    ...
    def test_update_combination_no_telescope_no_camera_returns_none(self, temp_data_dir, test_user_id):
        ...
        result = equipment_profiles.update_combination(
            test_user_id, combo['id'], {'name': 'Bad', 'telescope_id': None, 'camera_id': None}
        )
        assert result is None
...
class TestEquipmentExceptionHandlers:
    ...
    def test_create_combination_exception_returns_none(self, temp_data_dir, test_user_id):
        ...
        result = equipment_profiles.create_combination(
            test_user_id,
            {
    ...
    def test_update_filter_not_found_returns_none(self, temp_data_dir, test_user_id):
        ...
        equipment_profiles.create_filter(test_user_id, {'name': 'F', 'filter_type': 'Narrowband'})
        result = equipment_profiles.update_filter(test_user_id, 'nonexistent-id', {'name': 'X', 'filter_type': 'LP'})
        assert result is None
    ...
    def test_update_combination_not_found_returns_none(self, temp_data_dir, test_user_id):
        ...
        equipment_profiles.create_combination(test_user_id, {'name': 'C', 'telescope_id': scope['id']})
        result = equipment_profiles.update_combination(
            test_user_id, 'nonexistent-id', {'name': 'X', 'telescope_id': scope['id']}
        )
        assert result is None
    ...
    def test_update_camera_with_weight_covers_float_return(self, temp_data_dir, test_user_id):
        ...
        result = equipment_profiles.update_camera(
            ...
            cam['id'],
            {
                ...
                'pixel_size_um': 3.8,
                'sensor_type': 'CMOS',
                'weight_kg': '2.5',  # non-empty → covers float(value) path
            },
        )
...
class TestAnalyzeCombination:
    ...
    def _make_camera(self, user_id, pixel_size_um=3.0, sensor_w=10, sensor_h=7, weight_kg=None, include_pixel=True):
        data = {
            'name': 'Cam',
            'manufacturer': 'M',
    ...
    def _make_mount(self, user_id, recommended_payload=20):
        return equipment_profiles.create_mount(
            user_id,
            {
                'name': 'Mount',
                'mount_type': 'Equatorial',
    ...
    def test_analyze_exception_returns_none(self, temp_data_dir, test_user_id, monkeypatch):
        ...
        monkeypatch.setattr(
            equipment_profiles, 'get_telescope', lambda *_: (_ for _ in ()).throw(RuntimeError("disk error"))
        )
        result = equipment_profiles.analyze_combination(test_user_id, combo['id'])
        assert result is None
