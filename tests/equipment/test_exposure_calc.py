...
class TestComputeExposure:
    ...
    def test_calibration_asi294_f7_bortle5(self):
        ...
        assert 0.4 < r["B_sky"] < 2.0, f"Sky background {r['B_sky']:.3f} e/px/s out of expected 0.4–2.0 range"

    def test_darker_sky_lower_background(self):
        """Bortle 1 gives lower sky background than Bortle 9."""
        base = dict(aperture_mm=100, focal_length_mm=500, pixel_size_um=3.0, read_noise_e=4, qe=0.65, total_hours=1)
    ...
    def test_larger_aperture_more_background(self):
        ...
        base = dict(focal_length_mm=800, pixel_size_um=3.8, read_noise_e=4, qe=0.65, bortle=5, total_hours=1)
    ...
    def test_faster_focal_ratio_more_background(self):
        ...
        base = dict(aperture_mm=150, pixel_size_um=3.8, read_noise_e=4, qe=0.65, bortle=5, total_hours=1)
    ...
    def test_higher_read_noise_longer_sub(self):
        ...
        base = dict(aperture_mm=100, focal_length_mm=500, pixel_size_um=3.8, qe=0.65, bortle=5, total_hours=3)
    ...
    def test_qe_scales_background_linearly(self):
        ...
        base = dict(aperture_mm=100, focal_length_mm=500, pixel_size_um=3.8, read_noise_e=4, bortle=5, total_hours=2)
