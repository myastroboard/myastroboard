"""AllSky connector Blueprint. Routes: /api/connectors/allsky/*

Backed by connectors/allsky_connector.py. The registry listing itself is in
...
@connectors_allsky_bp.route('/api/connectors/allsky/urls', methods=['GET'])
@login_required
def allsky_urls_api():
...
@connectors_allsky_bp.route('/api/connectors/allsky/proxy', methods=['GET'])
@login_required
