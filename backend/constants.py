...
SKYTONIGHT_PREFERRED_NAME_ORDER = ['CommonName', 'Messier', 'OpenNGC', 'OpenIC', 'Caldwell', 'LBN', 'Herschel400', 'Pensack500', 'GaryImm', 'Arp', 'Sharpless', 'Barnard', 'vdB', 'AbellPNe', 'AbellClusters']
